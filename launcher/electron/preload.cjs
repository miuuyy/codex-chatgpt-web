...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  setBiggerContextPlan: (plan) => ipcRenderer.invoke("launcher:bigger-context-plan", plan),
  setAllowWebSubagents: (enabled) => ipcRenderer.invoke("launcher:allow-web-subagents", enabled),
