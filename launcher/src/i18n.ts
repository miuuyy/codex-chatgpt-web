...
const en = {
  ...
  chatgptPlanBody: "Configured TXT budgets, including instructions and images: Plus — Instant 123k, others 270k; Pro — Instant 123k, others 400k. These are not guarantees of full recall; Plus still needs live account verification. Restart Codex after changing this.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "TXT 配置预算包含指令和图片：Plus 为 Instant 123k、其余 270k；Pro 为 Instant 123k、其余 400k。这不保证完整记忆，Plus 仍待真实账号验证。更改后请重启 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
...
const ja: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "指示と画像を含む TXT 予算：Plus は Instant 123k、その他 270k。Pro は Instant 123k、その他 400k。完全な記憶を保証する値ではなく、Plus 実アカウントの検証は未実施です。変更後は Codex を再起動してください。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "TXT 設定預算包含指令和圖片：Plus 為 Instant 123k、其餘 270k；Pro 為 Instant 123k、其餘 400k。這不保證完整記憶，Plus 仍待真實帳號驗證。變更後請重新啟動 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
