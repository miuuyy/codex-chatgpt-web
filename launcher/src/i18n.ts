...
const en = {
  ...
  hideDockIconBody: "Keep Codex Web GPT in the menu bar without taking space in the Dock.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  hideDockIconBody: "让 Codex Web GPT 保留在菜单栏中，不占用 Dock 空间。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  hideDockIconBody: "Codex Web GPT をメニューバーに残し、Dock のスペースを使わないようにします。",
