...
const en = {
  ...
  stepInstallExternal: "Start as an OpenCodex provider",
  stepInstallExternalBody: "Start the local Responses server and browser session without changing Codex routing. Register this loopback /v1 URL in OpenCodex, then choose a ChatGPT Web model there.",
  integrationMode: "Codex routing",
  integrationModeBody: "Direct mode lets this launcher own openai_base_url. External-provider mode leaves Codex routing to OpenCodex.",
  integrationDirect: "Direct Codex route",
  integrationExternal: "OpenCodex provider",
  routingOwnerExternal: "Codex routing is owned by OpenCodex. Install, Repair, and restart will not change openai_base_url.",
  providerAddress: "Provider URL",
  restartOpenCodex: "Keep Codex pointed at OpenCodex, then refresh that provider catalog if the Web models are missing.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  stepInstallExternal: "作为 OpenCodex 供应商启动",
  stepInstallExternalBody: "启动本地 Responses 服务器和浏览器会话，但不更改 Codex 路由。请在 OpenCodex 中注册此 loopback /v1 地址，然后在那里选择 ChatGPT Web 模型。",
  integrationMode: "Codex 路由",
  integrationModeBody: "直接模式由本启动器管理 openai_base_url。外部供应商模式将 Codex 路由交给 OpenCodex。",
  integrationDirect: "直接 Codex 路由",
  integrationExternal: "OpenCodex 供应商",
  routingOwnerExternal: "Codex 路由由 OpenCodex 管理。安装、修复和重启都不会更改 openai_base_url。",
  providerAddress: "供应商地址",
  restartOpenCodex: "请保持 Codex 指向 OpenCodex。如果看不到 Web 模型，请刷新该供应商的模型目录。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  stepInstallExternal: "OpenCodex プロバイダーとして起動",
  stepInstallExternalBody: "Codex のルーティングは変更せず、ローカルの Responses サーバーとブラウザーセッションだけを起動します。この loopback /v1 URL を OpenCodex に登録し、そこで ChatGPT Web モデルを選んでください。",
  integrationMode: "Codex ルーティング",
  integrationModeBody: "Direct モードではこのランチャーが openai_base_url を管理します。External-provider モードでは OpenCodex が Codex ルーティングを管理します。",
  integrationDirect: "Direct Codex ルート",
  integrationExternal: "OpenCodex プロバイダー",
  routingOwnerExternal: "Codex ルーティングは OpenCodex が管理します。インストール、修復、再起動でも openai_base_url は変わりません。",
  providerAddress: "プロバイダー URL",
  restartOpenCodex: "Codex は OpenCodex を指したままにしてください。Web モデルが表示されない場合は、そのプロバイダーのカタログを更新します。",
