...
const en = {
  ...
  hideDockIcon: "Hide app from Dock",
  hideDockIconBody: "Keep Codex Web GPT available from the menu bar without showing a second Dock icon.",
  hideTaskbarIcon: "Hide app from taskbar",
  hideTaskbarIconBody: "Keep Codex Web GPT available from the system tray without showing a taskbar icon.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  hideDockIcon: "在程序坞中隐藏应用",
  hideDockIconBody: "继续通过菜单栏使用 Codex Web GPT，同时不显示第二个程序坞图标。",
  hideTaskbarIcon: "在任务栏中隐藏应用",
  hideTaskbarIconBody: "继续通过系统托盘使用 Codex Web GPT，同时不显示任务栏图标。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  hideDockIcon: "Dock からアプリを隠す",
  hideDockIconBody: "2つ目の Dock アイコンを表示せず、メニューバーから Codex Web GPT を利用できる状態に保ちます。",
  hideTaskbarIcon: "タスクバーからアプリを隠す",
  hideTaskbarIconBody: "タスクバーアイコンを表示せず、システムトレイから Codex Web GPT を利用できる状態に保ちます。",
