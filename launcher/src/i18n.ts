...
const en = {
  ...
  mcpDisconnect: "Disconnect MCP",
  mcpConnected: "MCP connected",
  mcpDisconnected: "MCP not connected",
  mcpConnecting: "Connecting MCP",
  mcpDisconnecting: "Disconnecting MCP",
  mcpUnavailable: "Configure MCP first",
  ...
  connectorMigrationNotice: "If an existing connector needs authorization again, choose Connect or Reconnect. If neither action is shown, edit it with the exact settings below, save it, and connect again; deletion is not normally required.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  connect: "连接 Harness",
  mcpConnect: "连接 MCP",
  mcpDisconnect: "断开 MCP",
  mcpConnected: "MCP 已连接",
  mcpDisconnected: "MCP 未连接",
  mcpConnecting: "正在连接 MCP",
  mcpDisconnecting: "正在断开 MCP",
  mcpUnavailable: "需要先配置 MCP",
  ...
  connectorMigrationNotice: "已有连接器需要重新授权时，请选择“连接”或“重新连接”；如果没有这两个操作，就按下方准确设置编辑并保存，再次连接。通常无需删除连接器。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  connect: "ハーネスを接続",
  mcpConnect: "MCP を接続",
  mcpDisconnect: "MCP を切断",
  mcpConnected: "MCP 接続済み",
  mcpDisconnected: "MCP 未接続",
  mcpConnecting: "MCP に接続中",
  mcpDisconnecting: "MCP を切断中",
  mcpUnavailable: "MCP の設定が必要",
  reconnect: "ハーネスを再接続",
  ...
  connectorMigrationNotice: "既存コネクタの再認可が必要な場合は Connect または Reconnect を選択します。どちらも表示されない場合は、下の正確な設定で編集して保存し、もう一度接続します。通常、削除は不要です。",
