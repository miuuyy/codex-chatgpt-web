...
const en = {
  ...
  homeSubtitle: "Your ChatGPT Web workspace, Codex connection, and local runtime at a glance.",
  accountStatus: "ChatGPT account",
  accountReady: "Signed in and ready",
  accountSignedOut: "Sign in to start chatting",
  codexStatus: "Codex integration",
  codexReady: "Models installed and verified",
  codexNeedsSetup: "Complete setup to enable models",
  mcpReadyDetail: "Local tools connected",
  mcpOptionalDetail: "Optional tool connection not configured",
  activeChats: "Chat sessions",
  activeChatsRunning: "{count} currently active",
  activeChatsIdle: "No active turn",
  quickActions: "Quick actions",
  openChat: "Open ChatGPT",
  openChatBody: "Continue your embedded ChatGPT sessions",
  viewAll: "View all",
  ...
  mcpStepTwoBody: "Choose the connector name, then paste the Tunnel ID and API key. The tunnel must belong to the same OpenAI account that will use the ChatGPT plugin. The key stays in private local storage and is never written to launcher logs.",
  ...
  openAiTunnel: "OpenAI Tunnel",
  cloudflareTunnel: "Cloudflare named tunnel",
  tunnelId: "Tunnel ID",
  ...
  mcpStepThreeBody: "Before creating the connector, enable Developer Mode in ChatGPT Settings. In ChatGPT Plugins, create a new connector, choose Tunnel, select the tunnel you created, set Authentication to None, and use the exact connector name shown below. Open Permissions and choose Allow all actions; Allow low-risk actions blocks local command calls. Then verify the runtime.",
  cloudflareConnectorBody: "Enable Developer Mode in ChatGPT Settings, create a custom MCP connector with the exact name and URL below, and choose OAuth with DCR. In Advanced OAuth settings, paste the Registration URL, leave token endpoint authentication as None, then enter the local passphrase when the authorization page opens. Choose Allow all actions for Permissions.",
  connectorMigrationNotice: "This release changes the MCP authentication contract. Delete any connector using this same name, then recreate it with the exact name and settings shown below.",
  openConnectors: "Open ChatGPT Plugins",
  connectorName: "Connector name",
  connectorUrl: "Connector URL",
  authentication: "Authentication",
  authenticationNone: "None",
  authenticationOAuth: "OAuth (DCR)",
  registrationUrl: "Registration URL",
  authorizationPassphrase: "Authorization passphrase",
  permissions: "Permissions",
  allowAllActions: "Allow all actions",
  cloudflareConfig: "Cloudflare config",
  cloudflareHostname: "Public hostname",
  cloudflaredBinary: "cloudflared executable",
  browse: "Browse…",
  ...
  copySafeLog: "Copy to clipboard",
  saveSafeLog: "Export to file",
  safeLogCopied: "Safe log copied to the clipboard",
  safeLogSaved: "Safe log exported to a file",
  ...
  warnings: "Warnings",
  errors: "Errors",
  noMatchingEvents: "No events match this filter.",
  ...
  runDoctorBody: "Check the local runtime, browser, and Codex integration.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  chat: "聊天",
  homeTitle: "欢迎回来",
  homeSubtitle: "集中查看 ChatGPT Web 工作区、Codex 连接和本地运行时状态。",
  accountStatus: "ChatGPT 账户",
  accountReady: "已登录并可用",
  accountSignedOut: "登录后即可开始聊天",
  codexStatus: "Codex 集成",
  codexReady: "模型已安装并验证",
  codexNeedsSetup: "完成设置以启用模型",
  mcpReadyDetail: "本地工具已连接",
  mcpOptionalDetail: "尚未配置可选工具连接",
  activeChats: "聊天会话",
  activeChatsRunning: "当前有 {count} 个活动会话",
  activeChatsIdle: "当前没有活动任务",
  quickActions: "快捷操作",
  openChat: "打开 ChatGPT",
  openChatBody: "继续使用内置的 ChatGPT 会话",
  viewAll: "查看全部",
  ...
  mcpStepTwoBody: "先自定义连接器名称，再粘贴 Tunnel ID 和 API key。Tunnel 必须属于将使用该 ChatGPT 插件的同一 OpenAI 账户。密钥只保存在本机私有存储中，绝不会写入启动器日志。",
  mcpStepTwoHint: "只有此步骤成功且 Tunnel 正在运行后，才能在 ChatGPT 中添加 MCP 连接器。",
  tunnelProvider: "隧道类型",
  openAiTunnel: "OpenAI Tunnel",
  cloudflareTunnel: "Cloudflare 固定隧道",
  tunnelId: "Tunnel ID",
  ...
  mcpStepThreeBody: "创建连接器前，先在 ChatGPT 设置中启用开发者模式。然后在 ChatGPT Plugins 中新建连接器，选择 Tunnel，选中刚创建的 Tunnel，将身份验证设为无，并使用下方显示的准确连接器名称。打开权限并选择“允许所有操作”；“允许低风险操作”会拦截本地命令调用。最后验证运行时。",
  cloudflareConnectorBody: "先在 ChatGPT 设置中启用开发者模式，再使用下方准确的名称和 URL 新建自定义 MCP 连接器，身份验证选择 OAuth（DCR）。在高级 OAuth 设置中粘贴 Registration URL，Token endpoint 身份验证保持 None；打开授权页面后输入下方本机授权口令。权限选择“允许所有操作”。",
  connectorMigrationNotice: "此版本更改了 MCP 身份验证合约。请删除使用相同名称的旧连接器，再按下方准确名称和设置重新创建。",
  openConnectors: "打开 ChatGPT Plugins",
  connectorName: "连接器名称",
  connectorUrl: "连接器 URL",
  authentication: "身份验证",
  authenticationNone: "无",
  authenticationOAuth: "OAuth（DCR）",
  registrationUrl: "Registration URL",
  authorizationPassphrase: "授权口令",
  permissions: "权限",
  allowAllActions: "允许所有操作",
  cloudflareConfig: "Cloudflare 配置",
  cloudflareHostname: "公网 hostname",
  cloudflaredBinary: "cloudflared 程序",
  browse: "选择…",
  verifyRuntime: "验证运行时",
  activityTitle: "运行时活动",
  ...
  copySafeLog: "复制到剪贴板",
  saveSafeLog: "导出到文件",
  safeLogCopied: "安全日志已复制到剪贴板",
  safeLogSaved: "安全日志已导出到文件",
  clearLogs: "清理日志",
  totalEvents: "事件总数",
  warningEvents: "警告",
  errorEvents: "错误",
  ...
  warnings: "警告",
  errors: "错误",
  noMatchingEvents: "没有符合当前筛选条件的事件。",
  settingsTitle: "启动器设置",
  general: "通用",
  launchAtLogin: "登录时启动",
  ...
  diagnostics: "诊断",
  runDoctor: "运行诊断",
  runDoctorBody: "检查本地运行时、浏览器和 Codex 集成状态。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  chat: "チャット",
  homeTitle: "おかえりなさい",
  homeSubtitle: "ChatGPT Web ワークスペース、Codex 接続、ローカルランタイムを一覧で確認できます。",
  accountStatus: "ChatGPT アカウント",
  accountReady: "サインイン済み・利用可能",
  accountSignedOut: "チャットを始めるにはサインインしてください",
  codexStatus: "Codex 連携",
  codexReady: "モデルはインストール・検証済み",
  codexNeedsSetup: "モデルを有効にするにはセットアップを完了してください",
  mcpReadyDetail: "ローカルツール接続済み",
  mcpOptionalDetail: "任意のツール接続は未設定です",
  activeChats: "チャットセッション",
  activeChatsRunning: "{count} 件が実行中",
  activeChatsIdle: "実行中のターンはありません",
  quickActions: "クイックアクション",
  openChat: "ChatGPT を開く",
  openChatBody: "内蔵 ChatGPT セッションを続ける",
  viewAll: "すべて表示",
  ...
  mcpStepTwoBody: "コネクタ名を指定してから Tunnel ID と API キーを貼り付けます。トンネルは、ChatGPT プラグインを使用する OpenAI アカウントと同じアカウントに属している必要があります。キーは非公開のローカルストレージに保存され、ランチャーログには記録されません。",
  mcpStepTwoHint: "この手順が成功し、トンネルが実行中になってから ChatGPT に MCP コネクタを追加できます。",
  tunnelProvider: "トンネルプロバイダー",
  openAiTunnel: "OpenAI Tunnel",
  cloudflareTunnel: "Cloudflare 名前付きトンネル",
  tunnelId: "Tunnel ID",
  ...
  mcpStepThreeBody: "コネクタを作成する前に、ChatGPT の設定で Developer Mode を有効にしてください。ChatGPT Plugins で新しいコネクタを作成し、Tunnel を選択して、作成したトンネルを指定します。Authentication は None に設定し、下記のコネクタ名を正確に使用してください。Permissions を開き、Allow all actions を選択します。Allow low-risk actions ではローカルコマンド呼び出しがブロックされます。最後にランタイムを検証します。",
  cloudflareConnectorBody: "ChatGPT の設定で Developer Mode を有効にし、下の正確な名前と URL でカスタム MCP コネクタを作成して、OAuth（DCR）を選びます。Advanced OAuth settings に Registration URL を貼り、token endpoint authentication は None のままにします。認可ページで下のローカルパスフレーズを入力し、Permissions は Allow all actions を選択してください。",
  connectorMigrationNotice: "このリリースでは MCP 認証契約が変更されています。同じ名前の既存コネクタを削除し、下の正確な名前と設定で作り直してください。",
  openConnectors: "ChatGPT Plugins を開く",
  connectorName: "コネクタ名",
  connectorUrl: "コネクタ URL",
  authentication: "認証",
  authenticationNone: "なし",
  authenticationOAuth: "OAuth（DCR）",
  registrationUrl: "Registration URL",
  authorizationPassphrase: "認可パスフレーズ",
  permissions: "権限",
  allowAllActions: "すべての操作を許可",
  cloudflareConfig: "Cloudflare 設定",
  cloudflareHostname: "公開ホスト名",
  cloudflaredBinary: "cloudflared 実行ファイル",
  browse: "選択…",
  ...
  copySafeLog: "クリップボードにコピー",
  saveSafeLog: "ファイルにエクスポート",
  safeLogCopied: "安全なログをクリップボードにコピーしました",
  safeLogSaved: "安全なログをファイルにエクスポートしました",
  clearLogs: "ログを消去",
  totalEvents: "イベント総数",
  warningEvents: "警告",
  errorEvents: "エラー",
  filterEvents: "イベントを絞り込む",
  allEvents: "すべて",
  warnings: "警告",
  errors: "エラー",
  noMatchingEvents: "このフィルターに一致するイベントはありません。",
  ...
  diagnostics: "診断",
  runDoctor: "診断を実行",
  runDoctorBody: "ローカルランタイム、ブラウザー、Codex 統合を確認します。",
