...
const en = {
  ...
  externalProvider: "External Responses provider",
  externalProviderBody: "Codex is routed through {name}. Disconnecting restores the exact provider and authentication files that were present before installation.",
  disconnectExternalProvider: "Disconnect external provider",
  externalInstallTitle: "Install Responses provider into Codex",
  externalInstallBody: "This will route all native Codex model traffic through the endpoint below until you disconnect it. The launcher saves and restores the current Codex route and authentication files.",
  externalInstallEndpoint: "Responses endpoint",
  externalInstallKey: "Downstream API key",
  externalInstallKeyHint: "The key is sent only to the local installer, stored in Codex auth.json with private permissions, and never placed in the browser link or launcher logs.",
  externalInstallAllowance: "ChatGPT Web allowance is used through unofficial browser automation. It is not converted into OpenAI API credit.",
  externalInstallTools: "Installing the provider does not grant local computer access. Configure the Full MCP harness separately for local Codex tools.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  externalProvider: "外部 Responses 提供方",
  externalProviderBody: "Codex 当前通过 {name} 路由。断开后会准确恢复安装前的提供方与认证文件。",
  disconnectExternalProvider: "断开外部提供方",
  externalInstallTitle: "将 Responses 提供方安装到 Codex",
  externalInstallBody: "在断开前，原生 Codex 的全部模型流量都会通过下方端点。启动器会保存并恢复当前 Codex 路由与认证文件。",
  externalInstallEndpoint: "Responses 端点",
  externalInstallKey: "下游 API key",
  externalInstallKeyHint: "密钥仅发送到本机安装器，以私有权限写入 Codex auth.json；不会放入浏览器链接或启动器日志。",
  externalInstallAllowance: "ChatGPT Web 用量通过非官方浏览器自动化使用，不会转换为 OpenAI API 余额。",
  externalInstallTools: "安装提供方不会授予本地电脑访问权限。若需使用本地 Codex 工具，请另行配置 Full MCP Harness。",
  installProvider: "安装提供方",
  cancel: "取消",
