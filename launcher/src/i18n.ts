...
const en = {
  ...
  chatgptPlanBody: "Plus: Instant 123k, others 270k. Pro: Instant 128k, others 400k. Restart Codex after changing this.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "Plus：Instant 123k，其余 270k。Pro：Instant 128k，其余 400k。更改后请重启 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
...
const ja: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "Plus：Instant 123k、その他 270k。Pro：Instant 128k、その他 400k。変更後は Codex を再起動してください。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "Plus：Instant 123k，其餘 270k。Pro：Instant 128k，其餘 400k。變更後請重新啟動 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
