...
const en = {
  ...
  hideDockIconBody: "Keep Codex Web GPT in the menu bar only. Click the menu bar icon to reopen this window.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  hideDockIcon: "隐藏程序坞图标",
  hideDockIconBody: "仅在菜单栏中保留 Codex Web GPT。点击菜单栏图标即可重新打开此窗口。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  hideDockIcon: "Dock アイコンを隠す",
  hideDockIconBody: "Codex Web GPT をメニューバーだけに残します。メニューバーのアイコンをクリックするとこのウィンドウを再表示できます。",
