...
const en = {
  ...
  hideTab: "Close tab",
  browserTabLimit: "No fixed app limit. Open as many ChatGPT Web tabs as your computer and ChatGPT account can handle.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  hideTab: "关闭标签页",
  browserTabLimit: "应用不再限制 ChatGPT Web 标签页数量。您可以打开任意数量，但仍受电脑资源和 ChatGPT 帐户限制。",
