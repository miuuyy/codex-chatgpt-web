...
const en = {
  ...
  chatgptPlanBody: "Plus keeps the original Bigger Context windows. Pro uses Instant 128k and 400k for other efforts. Restart Codex after changing this.",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "Allow ChatGPT Web sub-agents",
  webSubagentsBody: "When off, ChatGPT Web models cannot spawn Codex sub-agents. Official and CPA models are unchanged. Restart Codex after changing this.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "Plus 使用原本的 Bigger Context 视窗。Pro 才使用 Instant 128k，其余 400k。更改后请重启 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "允许 ChatGPT Web 使用子代理",
  webSubagentsBody: "关闭时，ChatGPT Web 模型不能生成 Codex 子代理。官方与 CPA 模型不受影响。更改后请重启 Codex。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "Plus は従来の Bigger Context ウィンドウを使います。Pro は Instant 128k、その他 400k です。変更後は Codex を再起動してください。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "ChatGPT Web のサブエージェントを許可",
  webSubagentsBody: "オフのとき、ChatGPT Web モデルは Codex サブエージェントを生成できません。公式および CPA モデルは変わりません。変更後は Codex を再起動してください。",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  chatgptPlanBody: "Plus 使用原本的 Bigger Context 視窗。Pro 才使用 Instant 128k，其餘 400k。變更後請重新啟動 Codex。",
  chatgptPlanPlus: "Plus",
  chatgptPlanPro: "Pro",
  webSubagents: "允許 ChatGPT Web 使用子代理",
  webSubagentsBody: "關閉時，ChatGPT Web 模型不能產生 Codex 子代理。官方與 CPA 模型不受影響。變更後請重新啟動 Codex。",
