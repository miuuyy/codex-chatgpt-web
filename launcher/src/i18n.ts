...
const en = {
  ...
  newChatTabHint: "Open a separate temporary conversation using the same sign-in.",
  browserTabLimit: "Up to ten simultaneous ChatGPT Web tabs. The limit avoids excessive parallel traffic on your ChatGPT account.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  hideTab: "关闭标签页",
  newChatTab: "新建聊天标签页",
  newChatTabHint: "使用同一登录状态打开独立的临时对话。",
  browserTabLimit: "最多可同时运行十个 ChatGPT Web 标签页，以避免向您的 ChatGPT 帐户发送过多并行流量。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  newChatTabHint: "同じログイン状態で別の一時チャットを開きます。",
  browserTabLimit: "ChatGPT Web のタブは同時に 10 件まで使用できます。ChatGPT アカウントへの過剰な並列トラフィックを防ぐための上限です。",
