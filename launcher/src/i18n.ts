...
const en = {
  ...
  stepAccountBody: "Use the private embedded browser, or sign in with a passkey in a temporary system-browser window. When ChatGPT is ready, return here and continue.",
  signIn: "Open sign in",
  systemSignIn: "Passkey sign in",
  continueSystemSignIn: "I'm signed in — Continue",
  continuingSystemSignIn: "Continuing…",
  continueSystemSignInBody: "Finish signing in within the dedicated normal browser. When the Temporary Chat composer is visible, return here and continue the secure transfer.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  stepAccountBody: "使用私有内置浏览器登录；通行密钥和高级安全账户可改用临时系统浏览器窗口。ChatGPT 就绪后，请返回此处继续。",
  signIn: "打开登录",
  systemSignIn: "通行密钥登录",
  continueSystemSignIn: "我已登录 — 继续",
  continuingSystemSignIn: "正在继续…",
  continueSystemSignInBody: "请在专用的普通浏览器中完成登录。看到临时聊天输入框后，返回此处继续安全传输。",
