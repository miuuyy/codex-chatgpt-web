...
const en = {
  ...
  bridgeConnect: "Connect Codex",
  bridgeDisconnect: "Disconnect Codex",
  bridgeConnected: "Codex connected",
  bridgeDisconnected: "Codex not connected",
  bridgeConnecting: "Connecting Codex",
  bridgeDisconnecting: "Disconnecting Codex",
  bridgeUnavailable: "Setup required",
  ...
  autoConnectMcp: "Connect MCP on launch",
  autoConnectMcpBody: "Start the configured MCP tunnel automatically when the launcher opens. Changes apply on the next launch.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  connect: "连接 Harness",
  bridgeConnect: "连接 Codex",
  bridgeDisconnect: "断开 Codex",
  bridgeConnected: "Codex 已连接",
  bridgeDisconnected: "Codex 未连接",
  bridgeConnecting: "正在连接 Codex",
  bridgeDisconnecting: "正在断开 Codex",
  bridgeUnavailable: "需要先完成设置",
  ...
  autoConnectMcp: "启动后自动连接 MCP",
  autoConnectMcpBody: "启动器打开时自动启动已配置的 MCP Tunnel；更改将在下次启动时生效。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  connect: "ハーネスを接続",
  bridgeConnect: "Codex を接続",
  bridgeDisconnect: "Codex を切断",
  bridgeConnected: "Codex 接続済み",
  bridgeDisconnected: "Codex 未接続",
  bridgeConnecting: "Codex に接続中",
  bridgeDisconnecting: "Codex を切断中",
  bridgeUnavailable: "セットアップが必要",
  reconnect: "ハーネスを再接続",
  ...
  autoConnectMcp: "起動時に MCP を接続",
  autoConnectMcpBody: "ランチャーを開いたとき、設定済みの MCP トンネルを自動的に起動します。変更は次回起動時に反映されます。",
