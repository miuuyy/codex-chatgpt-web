...
const en = {
  ...
  stepAccountBody: "Sign in through your system default browser. Only the verified ChatGPT session is imported into this launcher's private profile.",
  signIn: "Open sign in",
...
const zh: Record<keyof typeof en, string> = {
  ...
  stepAccountBody: "通过系统默认浏览器登录。只有经过验证的 ChatGPT 会话会导入此启动器的私有配置。",
  signIn: "打开登录",
