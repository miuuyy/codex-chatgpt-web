...
const en = {
  ...
  webUsage: "ChatGPT Web usage",
  webUsageLast24h: "bridge turns, last 24h",
  webUsageLast7d: "bridge turns, last 7 days",
  webUsageStatus: "web rate-limit status",
  webUsageNormal: "Normal",
  webUsageLimited: "Limited",
  webUsageLastRateLimit: "Last observed rate limit",
  webUsageNever: "never",
  webUsageUnavailable: "Usage data is unavailable right now.",
  webUsageNote: "ChatGPT publishes no numeric quota API. Counts cover bridge-driven turns on this machine only; usage from the ChatGPT UI or other devices is not included. Current official allowances: GPT-6 Pro 200 messages/week; GPT-5.6 Pro 170 messages/day with a 200 messages/day combined cap (Pro $200).",
...
const zh: Record<keyof typeof en, string> = {
  ...
  language: "语言",
  diagnostics: "诊断",
  webUsage: "ChatGPT 网页版用量",
  webUsageLast24h: "近 24 小时桥接轮次",
  webUsageLast7d: "近 7 天桥接轮次",
  webUsageStatus: "网页端限流状态",
  webUsageNormal: "正常",
  webUsageLimited: "已限流",
  webUsageLastRateLimit: "最近一次观测到限流",
  webUsageNever: "从未",
  webUsageUnavailable: "暂时无法获取用量数据。",
  webUsageNote: "ChatGPT 不开放数值化配额接口。统计仅覆盖本机桥接轮次，不包含网页版界面或其他设备的用量。官方当前上限：GPT-6 Pro 每周 200 条；GPT-5.6 Pro 每天 170 条，两模型合计每天 200 条（Pro $200）。",
  runDoctor: "运行诊断",
...
const ja: Record<keyof typeof en, string> = {
  ...
  language: "言語",
  diagnostics: "診断",
  webUsage: "ChatGPT Web 使用量",
  webUsageLast24h: "直近 24 時間のブリッジターン",
  webUsageLast7d: "直近 7 日間のブリッジターン",
  webUsageStatus: "Web レート制限状態",
  webUsageNormal: "正常",
  webUsageLimited: "制限中",
  webUsageLastRateLimit: "最後に検出されたレート制限",
  webUsageNever: "なし",
  webUsageUnavailable: "現在、使用量データを取得できません。",
  webUsageNote: "ChatGPT は数値化されたクォータ API を公開していません。集計はこのマシンのブリッジ経由ターンのみを対象とし、ChatGPT UI や他のデバイスでの使用は含まれません。現在の公式上限: GPT-6 Pro 200 メッセージ/週、GPT-5.6 Pro 170 メッセージ/日・合計 200 メッセージ/日 (Pro $200)。",
  runDoctor: "診断を実行",
