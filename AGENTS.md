...
- The Web sub-agent setting is namespace-aware and defaults off. It must never change native/non-Web model delegation. Preserve unrelated tools with coincidentally matching names.
