...
- The core supports plan-aware budgets; the follow-up plan-settings PR exposes the user-facing selector. Configured ceilings are not guarantees of full recall, and actual Plus-account file behavior still needs live verification.
